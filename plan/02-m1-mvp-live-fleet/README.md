...
| Exit | **the MVP**: ≥ 2 real vendor CLIs live in tmux panes inside per-task git worktrees, visible and controllable in the browser, every agent prompt surfaced in Attention and answerable from the web through official channels, Quick Delegate returns a branch + diff, daemon restart loses nothing |
...
- [ ] Contract tests for claude/codex/agy pass on recorded fixtures pinned to the installed CLI versions.
...
| M1-02 | [step-02](step-02-pty-port-and-sessionsupervisor.md) | PTY port & SessionSupervisor | 3 d | M1-01 |
...
| M1-05 | [step-05](step-05-claude-code-adapter-v1.md) | Claude Code adapter v1 | 4 d | M1-02, M1-04 |
| M1-06 | [step-06](step-06-codex-adapter-v1.md) | Codex adapter v1 | 4 d | M1-02, M1-04 (∥) |
| M1-07 | [step-07](step-07-antigravity-adapter-v1-opt-in.md) | Antigravity adapter v1 (opt-in) | 3 d | M1-02, M1-04 (∥) |
...
| M1-11 | [step-11](step-11-interaction-bridge-v1-and-attention-queue.md) | Interaction Bridge v1 & Attention queue | 4 d | M1-05, M1-08 |
| M1-12 | [step-12](step-12-quick-delegate-lite.md) | Quick Delegate lite | 2.5 d | M1-11, M1-03 |
| M1-13 | [step-13](step-13-mvp-acceptance.md) | MVP acceptance | 2 d | all M1 |
...
10. `pnpm test` → contract suites for claude/codex/agy green on fixtures `claude@2.1.216`, `codex@<ver>`, `agy@1.2.1`.
